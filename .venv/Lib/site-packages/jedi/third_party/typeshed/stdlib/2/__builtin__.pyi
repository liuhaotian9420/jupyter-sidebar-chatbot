...
class int:
    @overload
    def __new__(cls: Type[_T], x: Union[builtins.str, bytes, SupportsInt, _SupportsIndex, _SupportsTrunc] = ...) -> _T: ...
    @overload
    def __new__(cls: Type[_T], x: Union[builtins.str, bytes, bytearray], base: int) -> _T: ...
    @property
    def real(self) -> int: ...
    @property
    def imag(self) -> int: ...
...
class float:
    def __new__(cls: Type[_T], x: Union[SupportsFloat, _SupportsIndex, builtins.str, bytes, bytearray] = ...) -> _T: ...
...
class str(Sequence[str], basestring):
    ...
    def endswith(self, suffix: Union[builtins.str, Tuple[builtins.str, ...]]) -> bool: ...
    ...
    def startswith(self, prefix: Union[builtins.str, Tuple[builtins.str, ...]]) -> bool: ...
    @overload
...
class set(MutableSet[_T], Generic[_T]):
    ...
    @overload
    def __sub__(self: Set[str], s: AbstractSet[Optional[builtins.str]]) -> Set[_T]: ...
    @overload
    def __sub__(self, s: AbstractSet[Optional[_T]]) -> Set[_T]: ...
    @overload  # type: ignore
    def __isub__(self: Set[str], s: AbstractSet[Optional[builtins.str]]) -> Set[_T]: ...
    @overload
...
def eval(
    __source: Union[builtins.str, bytes, CodeType], __globals: Optional[Dict[str, Any]] = ..., __locals: Optional[Mapping[str, Any]] = ...
) -> Any: ...
