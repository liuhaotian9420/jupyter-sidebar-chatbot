...
class PoolResetState:
    ...
    __slots__ = ("asyncio_safe", "terminate_only", "transaction_was_reset")
...
class _ConnectionRecord(ConnectionPoolEntry):
    ...
    @property
    def driver_connection(self) -> Optional[Any]:  # type: ignore[override]  # mypy#4125
...
class _AdhocProxiedConnection(PoolProxiedConnection):
    ...
    __slots__ = ("_connection_record", "_is_valid", "dbapi_connection")
