...
from typing import Any, Callable, Deque, Dict, Optional, Set, Tuple, Type
...
class HasShallowCopy(HasTraverseInternals):
    ...
    def _shallow_copy_to(self, other: Self) -> None:
        ...
        try:
            ...
            cls._generated_shallow_copy_traversal = shallow_copy  # type: ignore
...
class TraversalComparatorStrategy(HasTraversalDispatch, util.MemoizedSlots):
    __slots__ = "anon_map", "cache", "stack"
