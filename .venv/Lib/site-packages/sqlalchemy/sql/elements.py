...
class SQLCoreOperations(Generic[_T_co], ColumnOperators, TypingOnly):
    ...
    if typing.TYPE_CHECKING:
        ...
        def __ne__(self, other: Any) -> ColumnElement[bool]:  # type: ignore[override]
            ...
...
class ColumnElement(
    ...
    def operate(
        ...
        **kwargs: Any,
        ...
        return op(self.comparator, *other, **kwargs)  # type: ignore[no-any-return]

    def reverse_operate(
        self, op: operators.OperatorType, other: Any, **kwargs: Any
    ) -> ColumnElement[Any]:
        return op(other, self.comparator, **kwargs)  # type: ignore[no-any-return]
    ...
    def _construct(
        ...
        **kw: Any,
        ...
        if lcc > 1:
            ...
            return cls._construct_raw(operator, flattened_clauses)  # type: ignore
        else:
            assert lcc
