...
class Join(roles.DMLTableRole, FromClause):
    ...
    def _populate_column_collection(
        ...
        foreign_keys.update(
            itertools.chain(*[col.foreign_keys for col in _columns])  # type: ignore
        )
