...
class FunctionElement(Executable, ColumnElement[_T], FromClause, Generative):
    ...
    def columns(self) -> ColumnCollection[str, KeyedColumnElement[Any]]:  # type: ignore[override]
    ...
    def c(self) -> ColumnCollection[str, KeyedColumnElement[Any]]:  # type: ignore[override]
