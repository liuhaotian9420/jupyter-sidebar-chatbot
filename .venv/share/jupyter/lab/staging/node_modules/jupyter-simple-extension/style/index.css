...
/* Controls container (Markdown toggle, @ etc.) within the Bottom Bar */
.jp-llm-ext-bottom-bar-container .jp-llm-ext-controls-container {
  display: flex; /* Keep controls side-by-side */
  align-items: center;
  flex-shrink: 0; /* Prevent controls from shrinking */
  gap: 8px; /* Space between toggle and action buttons */
...
.jp-llm-ext-controls-container .jp-llm-ext-action-buttons-container {
  display: flex;
  gap: 4px;
  margin: 0; /* Reset margin */
}

/* Input field within the Bottom Bar */
.jp-llm-ext-bottom-bar-container .jp-llm-ext-input-field {
  flex-grow: 1; /* Allow input field to take available space */
  width: auto; /* Override previous 100% width if set */
  resize: none; 
  border: 1px solid var(--jp-border-color1);
  border-radius: 3px;
  padding: 5px 8px;
...
/* Send button container within the Bottom Bar */
.jp-llm-ext-bottom-bar-container .jp-llm-ext-input-actions-container {
  display: flex;
  align-items: center; 
  margin: 0; /* Reset margin */
...
/* Send button itself */
.jp-llm-ext-bottom-bar-container .jp-llm-ext-send-button {
  flex: 0 0 auto; /* Don't grow or shrink, use natural width */
  height: 30px; /* Match input field height */
  padding: 0 12px; /* Adjust padding */
}

/* New Chat / History buttons within the Bottom Bar */
.jp-llm-ext-bottom-bar-container > .jp-Button.jp-llm-ext-action-button {
...
/* Remove the old input area container styles */
.jp-llm-ext-input-area-container {
  display: none; /* Or simply remove all rules */
}

/* Adjust message container padding if needed */
.jp-llm-ext-message-container {
...
/* Remove redundant rules conflicting with the above */
.jp-llm-ext-input-container {
  display: none; /* Hide if it's the old container */
}
