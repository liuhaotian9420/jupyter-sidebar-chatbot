 ...
 */
function isInScrollingNotebook(element) {
    if (!element) {
        return false;
    }
    const notebook = element.closest('.jp-WindowedPanel-viewport');
...
window.IntersectionObserver = class extends window.IntersectionObserver {
    constructor(callback, options) {
        ...
        this._throttler = new Throttler(entries => {
    ...
    constructor(cells, options) {
        ...
        this.estimateWidgetSize = (index) => {
            ...
            if (!cell) {
                ...
                console.warn(`estimateWidgetSize requested for cell ${index} in notebook with only ${this.cells.length} cells`);
                return 0;
            }
