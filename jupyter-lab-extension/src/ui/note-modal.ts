 ...
 */
export function createNoteModalElement(
  ...
  form.addEventListener('submit', (e) => {
    e.preventDefault();
    const titleInput = form.querySelector('.jp-llm-ext-note-modal-input') as HTMLInputElement;
    const contentTextarea = form.querySelector('.jp-llm-ext-note-modal-textarea') as HTMLTextAreaElement;
